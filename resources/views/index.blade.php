...
<body>
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex flex-wrap md:order-2">
                ...
                <button type="button"
                    ...
                    <a href="{{ route('login') }}"> {{ Auth::user()->username }}
                    </a></button>
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                <ul
                    ...
                    <li>
                        <a href="{{ route('home') }}"
                            class="block py-2 pl-3 pr-4 text-white bg-pink-600 rounded md:bg-transparent md:text-pink-600 md:p-0 md:dark:text-pink-600"
                            aria-current="page">Beranda</a>
                    </li>
                    <li>
                        <a href="{{ route('layanan') }}"
                            class="block py-2 pl-3 pr-4 text-black rounded hover:bg-pink-600 md:hover:bg-transparent md:hover:text-pink-600 md:p-0 md:dark:hover:text-pink-600 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Layanan</a>
                    </li>
                    <li>
    ...
    <!-- Visi Misi -->
    <section id="visi-misi" class="pt-36 flex items-center justify-center">
        <div class="container flex flex-wrap justify-between">
            <div class="w-full px-4">
                <div class="max-w-screen-xl mx-auto text-center mb-16">
                    <h4 class="font-semibold text-lg text-primary mb-2">Visi Misi Yayasan</h4>
            ...
            <div class="flex flex-warp">
                <div class="w-full self-end px-6 lg:w-1/2">
                    <div class="relative mt-10 lg:left-0">
                        <img src="img/5606469.png" alt="" class="max-w-full mx-auto">
                    </div>
                </div>
                <div class="w-full self-center px-40 lg:w-1/2">
                    <h1 class="block font-bold text-black text-4xl">Visi Yayasan</h1>
                    <ul class="list-disc list-outside px-6 mt-3 mb-8">
                        <li>Anak adalah amanah yang berhak akan perawatan dan perlindungan sejak semasa dalam kandungan
                            sampai sesudah dilahirkan.</li>
                        <li>Menjadi yayasan pramusiwi yang inovatif, kreatif, dan dikelola secara profesional dengan
                            sentuhan kemanusiaan.</li>
                    </ul>
                    <h1 class="block font-bold text-black text-4xl">Misi Yayasan</h1>
                    <ul class="list-decimal list-outside px-6 mt-3">
                        <li>Memberikan pelayanan pramusiwi yang terjamin kepada ibu dan anak sesuai standar profesi
                            melalui dukungan sumber daya manusia yang profesional dibidangnya.</li>
                        <li>Senantiasa berusaha untuk mewujudkan kepuasan pelanggan.</li>
                        <li>Memberdayakan pengurus dan anggota yayasan dalam menggali potensi-potensi yang ada.</li>
                        <li>Terwujudnya yayasan pramusiwi yang akuntabel dan transparan dalam hal tata organisasi dan
                            pelaporan kegiatan dan keuangan.</li>
                    </ul>
                </div>
